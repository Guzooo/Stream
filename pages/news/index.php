<html lang="pl">
    <head>
        ...
        <script src="../../values/prefabs/addGame2News.js"></script>
        <script src="../../values/code/page_news.js"></script>
        <script src="../../values/db/DB2ArrayNewsController.php"></script>
    </head>
    <body>
        <script>
            PrefabHeader.get();
